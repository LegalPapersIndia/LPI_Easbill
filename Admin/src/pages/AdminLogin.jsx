    ...
    <section className="min-h-screen bg-[#F8FAFC] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-[#E2E8F0] p-6 sm:p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-[#0F172A] font-display">BillFlow Admin</h1>
        </div>

        <h2 className="text-lg font-semibold text-[#0F172A] mb-1">Admin Login</h2>
        <p className="text-sm text-[#64748B] mb-5">Restricted access — authorized personnel only.</p>
