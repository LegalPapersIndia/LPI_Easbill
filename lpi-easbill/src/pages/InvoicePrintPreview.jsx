...
// import { salesInvoicesList, purchaseInvoicesList, contactsList, invoiceLineItemsSample } from "../data/dummyData";
...
//   const pool = type === "sales" ? salesInvoicesList : purchaseInvoicesList;
//   const invoice = pool.find((inv) => inv._id === id);

//   if (!invoice) {
//     return (
//       <div className="min-h-screen flex items-center justify-center">
//         <div className="text-center">
//           <p className="text-ink-muted mb-4">Invoice nahi mila.</p>
...
//   const partyName = type === "sales" ? invoice.customerName : invoice.supplierName;
//   const party = contactsList.find((c) => c.name === partyName);
//   const lines = invoiceLineItemsSample[invoice._id] || [
//     { name: "Sample Item", hsnCode: "0000", qty: 1, unit: "pcs", rate: invoice.grandTotal, gstPercent: 0 },
//   ];

//   const handleShareWhatsApp = () => {
//     const message = `Hi ${partyName}, aapka invoice ${invoice.invoiceNo || invoice.purchaseNo} ₹${invoice.grandTotal} ka ready hai. Dekhne ke liye is link ka use karo (backend connect hone ke baad direct PDF link yahan aayega).`;
//     window.open(`https://wa.me/?text=${encodeURIComponent(message)}`, "_blank");
//   };

//   return (
//     <div className="min-h-screen bg-paper">
//       {/* Toolbar — print mein hide hoga */}
