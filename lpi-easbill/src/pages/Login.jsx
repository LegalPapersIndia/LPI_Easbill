...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ── isSetupComplete se decide karo — companyId hamesha set 
      // rahega (empty ho ya bhara), isliye setup complete flag hi 
      // sahi indicator hai ki Dashboard pe bhejein ya Business 
      // Settings form pe ──
