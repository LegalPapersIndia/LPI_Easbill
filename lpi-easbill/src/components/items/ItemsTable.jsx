...
//                   <td className="py-3 px-4 tabular-num text-right text-ink-muted">₹{item.purchasePrice}</td>
//                   <td className="py-3 px-4 tabular-num text-right text-ink font-medium">₹{item.salePrice}</td>
